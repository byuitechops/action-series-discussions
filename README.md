# Action Series Discussions
### *Package Name*: action-series-discussions
...
```
npm install action-series-discussions
```
...
This module uses the discussions "template" and runs an asynchronous forEach on each discussion. The template provides methods and data used to complete the action-series model.
